...
<script setup>
// Replace these with your 4 image paths
const logos = [
...
@keyframes scroll {
    ...
    100% {
        /* We move only 1/3 of the total width (the length of one full set of 4 images) */
        transform: translateX(calc(-100% / 3));
    }
}

/* Optional: Pauses the slider when the user hovers */
